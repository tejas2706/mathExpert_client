            ...
            <div className="quizResult__innerContainer">
                ...
                <div className="quizResult__stars">
                    <div className="quizResult__badgeGroup">
                        <div><img className="star" alt="star" src={goldenStar}></img></div>
                        <div><img className="star" alt="star" src={goldenStar}></img></div>
                        <div><img className="star" alt="star" src={bwstar}></img></div>
                    </div>
                    <span className="quizResult__quizLine">Great! you have completed the test, Please find below the detailed solutions.</span>
                </div>
                ...
                <div className="quizResult__solutions">
                    <button className="quizResult__solution">Text Solution</button>
                    <button className="quizResult__solution">Video Solution</button>
                </div>
                <div>
                    <div>
                        <span className="quizResult__analysisTitle">Analysis ↓</span>
                    </div>
                            ...
                            questionsList.map((each)=>{
                                return(
                                    <div className="quizResult__eachQuestion">
                                            <img className="quizResult__questionImg" src={each.questionUrl} alt="question"></img>
                                            <div className="quizResult__answers">
                                                <div>
                                                    <h3>YOUR RESPONSE: &nbsp;{each.submittedAns}</h3>
                                                    <h3>CORRECT RESPONSE: &nbsp;{each.correctAns}</h3>
                                                </div>
                                                <h2 className={each.isCorrect ? "quizResult__correctAns" : "quizResult__wrongAns"}>{each.isCorrect ? "CORRECT 🤩" : "INCORRRECT 😕"}</h2>
                                            </div>
                                    </div>
                                )
                            })
