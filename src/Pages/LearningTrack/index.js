...
function LearningTrack({ subTopic = 'Circles' }) {
    ...
    learningTrack: [
      {
        ...
        duration: '5:23',
        tutorImageUrl:
          'https://spng.subpng.com/20180514/qbq/kisspng-jerry-mouse-tom-cat-nibbles-tom-and-jerry-cartoon-5af9bd5bc0d618.0028949915263163797899.jpg',
        tutorName: 'Jerry',
      ...
      },
      {
        ...
        duration: '10 mins',
        tutorImageUrl:
          'https://www.vhv.rs/dpng/d/492-4926944_tom-and-jerry-png-download-tom-y-jerry.png',
        tutorName: 'Tom',
  ...
  return (
    <div className="LearningTrack__container">
      <div className="LearningTrack__title">Learning Track for {subTopic}</div>
      <span className="LearningTrack__subtitle">
        <b>Go thorugh the following content to learn {subTopic}</b>
      </span>
        ...
        {subtopics.learningTrack.map((each) => {
          return (
            <div className="LearningTrack__eachItem">
              ...
              <div className="LearningTrack__eachItem_details">
                <h3 className="LearningTrack__eachItem_duration">
                  {each.duration}
                </h3>
                <div onMouseEnter={onHover} onMouseLeave={onLeave}>
                  <img
                    ...
                    alt="tutImage"
                    className="LearningTrack__eachItem_tutorImg"></img>
