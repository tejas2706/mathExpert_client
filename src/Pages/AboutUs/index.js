        ...
        <div className="aboutUs__container">
            <div className="aboutUs__innerContainer">
                <div className="aboutUs__aboutUs">
                    ...
                    <div className="aboutUs__content">
                        ...
                        <img
                            alt="tejas"
                            src={together}
                            className="aboutUs__image"></img>
                        have created MathExpert with the intent of preparing the
                        students for Olympiad exams and help them to do their
                        best in each and every topic of Mathematics. We provide
                        detailed explanation that includes video and audio of
                        all sorts of problem sums categoried by the topics and
                        classes.
                    </div>
                </div>
                <div className="aboutUs__contactUs">
                    <h1>Contact Us</h1>
                    <form
                        className="aboutUs__contactUsForm"
