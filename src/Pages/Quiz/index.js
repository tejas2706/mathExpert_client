                ...
                <div className="quiz__content">
                    {QuestionsList.map((eachQuestion, index) => {
                        return (<div className="quiz__eachQuestion">
                            <QuizQuestion questionDetails={eachQuestion} questionNumber={index} setquestionsAnswered={setquestionsAnswered} questionsAnswered={questionsAnswered} />
                        </div>);
                    })
                    }
                </div>
                        ...
                        <div className="quiz__questionsBlock__questions">
                            {
                                QuestionsList.map((each,index) => {
                                    return (
                                        <div className={`quiz__questionsBlock__eachQues ${questionsAnswered.hasOwnProperty(each.questionId) && "quiz__questionsBlock_eachQues_answered"}` }>
                                            {index + 1}
                                        </div>
                                    )
                                })
